...
class BlogEntryBlogCategoryMappingDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'werkl_blog_entry_blog_category';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            (new FkField('werkl_blog_entry_id', 'blogId', BlogEntryDefinition::class))->addFlags(new PrimaryKey(), new Required()),
            ...
            new ManyToOneAssociationField('blog', 'werkl_blog_entry_id', BlogEntryDefinition::class, 'id', false),
