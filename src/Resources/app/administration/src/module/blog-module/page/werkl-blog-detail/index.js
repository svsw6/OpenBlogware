...
export default {
    ...
    watch: {
        ...
        'blog.slug': function (newSlug) {
            // If the slug is different from the auto-generated one, mark as manually edited
            if (newSlug && this.autoGeneratedSlug && newSlug !== this.autoGeneratedSlug) {
    ...
    methods: {
        ...
        loadBlog(blogId) {
            ...
            return this.blogRepository.get(blogId, Context.api, this.loadBlogCriteria).then((entity) => {
                ...
                // Reset manual edit flag when loading existing blog
